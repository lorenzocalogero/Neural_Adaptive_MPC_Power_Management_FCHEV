function zoom_plot(h, ax, zoom_area, inset_pos, lines)
    % ************ MagInset.m *************
        ...
        if(nargin > 4)
            ...
            if((numLine>0) && (size(lines,2) == 2))
                ...
                for ii=1:1:numLine
                    ...
                    % Add the line:
                    annotation('line', lx,ly,'color',[0.6 0.6 0.6]);
                end
            end
        end
