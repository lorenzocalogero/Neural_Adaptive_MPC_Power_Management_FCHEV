%% NN-MPC control (closed-loop simulation)
...
[y, u, ~, max_exec_time] = nn_mpc_control(net, data);

fprintf('Average exec. time (MPC, 1 step) = %.4f ms\n',max_exec_time*1e03)
...
% exportgraphics(f1,'nn_mpc_bal_power_req.pdf','BackgroundColor','w');
% exportgraphics(f2,'nn_mpc_bal_power_split.pdf','BackgroundColor','w');
% exportgraphics(f3,'nn_mpc_bal_supplies.pdf','BackgroundColor','w');
